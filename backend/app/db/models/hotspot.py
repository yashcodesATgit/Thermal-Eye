...
class Hotspot(Base):
    ...
    # ML Classification predictions (Phase 6 — Decoupled from raw satellite 'type')
    ml_type = Column(String, nullable=True)  # industrial_fire | gas_flare | agricultural | wildfire | unknown
    ml_confidence = Column(Float, nullable=True)  # 0.0 to 1.0 ML confidence score
    model_version = Column(String, nullable=True, default="xgboost-v1")
