    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#080C14] text-[#E8EDF5]">
      ...
      <main className="flex-1 w-full p-6 overflow-y-auto max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        <div className="bg-[#111827] border border-[#1E2D45] rounded-2xl p-10 max-w-xl w-full shadow-2xl space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3 pt-4 border-t border-[#1E2D45] text-left">
            <div className="bg-[#162033]/50 border border-[#1E2D45] p-3 rounded-lg">
              <span className="text-[10px] font-bold text-[#7A8FA8] uppercase block">REFINERIES</span>
              <span className="text-lg font-bold text-[#E8EDF5] mt-1 block">3</span>
            </div>
            <div className="bg-[#162033]/50 border border-[#1E2D45] p-3 rounded-lg">
              <span className="text-[10px] font-bold text-[#7A8FA8] uppercase block">POWER PLANTS</span>
              <span className="text-lg font-bold text-[#E8EDF5] mt-1 block">4</span>
            </div>
            <div className="bg-[#162033]/50 border border-[#1E2D45] p-3 rounded-lg">
              <span className="text-[10px] font-bold text-[#7A8FA8] uppercase block">LNG TERMINALS</span>
              <span className="text-lg font-bold text-[#E8EDF5] mt-1 block">3</span>
            </div>
          </div>
        </div>
