...
export default function IncidentsPage(): React.JSX.Element {
  ...
  const handleExport = () => {
    ...
    downloadIncidentsCsv(filtered, `thermaleye-incidents-${now}.csv`);
  };
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#080C14] text-[#E8EDF5]">
      ...
      <main className="flex-1 w-full p-6 overflow-y-auto max-w-7xl mx-auto space-y-6">
        {/* Page Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#1E2D45] pb-4">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="bg-[#0F1623] border border-[#1E2D45] rounded-md pl-9 pr-3 py-1.5 text-xs text-[#E8EDF5] placeholder-[#7A8FA8]/60 focus:border-[#2D7DD2] focus:outline-none w-48 sm:w-64"
              />
            </div>
            ...
            <select
              ...
              className="bg-[#0F1623] border border-[#1E2D45] rounded-md px-3 py-1.5 text-xs text-[#E8EDF5] focus:outline-none focus:border-[#2D7DD2] appearance-none cursor-pointer"
            >
