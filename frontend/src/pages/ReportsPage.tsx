        ...
        <div className="bg-[#111827] border border-[#1E2D45] rounded-2xl p-10 max-w-xl w-full shadow-2xl space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#7A8FA8] leading-relaxed">
              Automated intelligence reports and thermal anomaly incident summaries.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-4 border-t border-[#1E2D45] text-left">
            <div className="bg-[#162033]/50 border border-[#1E2D45] p-3 rounded-lg">
              <span className="text-[10px] font-bold text-[#7A8FA8] uppercase block">DAILY SUMMARIES</span>
              <span className="text-lg font-bold text-[#E8EDF5] mt-1 block">7 Generated</span>
            </div>
            <div className="bg-[#162033]/50 border border-[#1E2D45] p-3 rounded-lg">
              <span className="text-[10px] font-bold text-[#7A8FA8] uppercase block">EXPORT FORMATS</span>
              <span className="text-sm font-semibold text-[#E8EDF5] mt-1.5 block font-mono">PDF, CSV, JSON</span>
            </div>
          </div>
        </div>
      </main>
